...
# choisir pour l'eau entre distance et surface
data <- list(
  cell_area = logarea,
  # x_1 = scale(grid_selec$surface_en_eau)[,1],
  x_1 = scale(grid_selec$dist_plan_eau)[,1],
...
# save(out_gbif, file = "out_gbif_5km2_dist.RData")
...
# Modèle multiples détections / routes_chemins ---------------------------------
...
# save(out_env_mult, file = "out_env_mult_5km2_dist.RData")
